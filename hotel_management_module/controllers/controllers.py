...
class HotelManagementModule(http.Controller):
    ...
    def index(self, **kw):
        ...
        return request.render('hotel_management_module.index', qcontext=context)
    ...
    @http.route('/hotel_management_module/events/list', auth='public')
    def object(self, **kw):
            ...
            if not creds or not creds.valid:
                if creds and creds.expired and creds.refresh_token:
                    ...
                    flow = InstalledAppFlow.from_client_secrets_file(
                        '/home/skyach/odoo/addons/hotel_management_module/controllers/credentials.json', SCOPES)
